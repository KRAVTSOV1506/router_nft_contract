...
interface XERC1155Interface extends ethers.utils.Interface {
  functions: {
    ...
    "transferCrossChain(string,(uint256[],uint256[],bytes,bytes),bytes)": FunctionFragment;
...
export class XERC1155 extends BaseContract {
